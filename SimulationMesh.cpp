...
SimulationMesh::SimulationMesh(Eigen::MatrixX3d Vbar,  Eigen::MatrixX3d V, Eigen::MatrixX3i Fin, double thickness)
{
...
void SimulationMesh::testElasticEnergy(VectorXm *dE, Eigen::SparseMatrix<double> *hEnergy1, Eigen::SparseMatrix<double> *hEnergy2)
{
    std::vector<Eigen::Triplet<scalar> > hEnergyList1, hEnergyList2;
    scalar result = shellEnergy(originalV, F, faceWings, baras, faceThicknesses, params, dE, &hEnergyList1, &hEnergyList2, NULL);
